  ...
  return (
    <div id='about' className='stats-page w-full h-screen flex overflow-hidden '>
      <div className='stats-left w-full h-screen flex flex-col'>
        <div className='flex flex-col justify-start font-montserrat m-12'>
          <div className='w-[500px] text-[22px] relative'>
            <h1 className='para-1' >
              At Campus-mate we offer just not hostel services but provide you with seamless experiences with our next gen add-ons
            </h1>
            <div className='my-10' >
          ...
          <div className='flex flex-col gap-8 my-24' >
            <div className='stats-div flex justify-between text-[40px] '>
              <div  ><h1 className='text-[60px] font-bold'>1000+</h1></div>
              <div className='w-[500px]' > <h1>Rooms <br /> for you</h1></div>
            </div>
            <div className='line-div w-full h-[5px] rounded-xl bg-gray-500' ></div>
            <div className='stats-div flex justify-between text-[40px] '>
              <div ><h1 className='text-[60px] font-bold'>80%</h1></div>
              <div className='w-[500px] right-0' > <h1>Student <br /> Satisfaction Rate</h1></div>
            </div>
            <div className='line-div w-full h-[5px] rounded-xl bg-gray-500' ></div>
            <div className='stats-div flex justify-between text-[40px] '>
              <div  ><h1 className='text-[60px] font-bold'>4.5/5</h1></div>
              <div className='w-[500px]' > <h1>Rated <br /> Mess food</h1></div>
            </div>
          </div>
        </div>
      </div>
      <div className='stats-right w-full h-screen flex justify-center py-10 relative'>
        ...
        <video className='video-1 rounded-[20px] w-full h-full object-cover mx-8' src="https://videos.pexels.com/video-files/6549985/uhd_25fps.mp4" autoPlay loop muted />
